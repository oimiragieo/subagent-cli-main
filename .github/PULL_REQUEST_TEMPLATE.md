...
- [ ] I have updated README.md with agent documentation
...
- [ ] I have tested tool on all supported platforms
...
<!-- Add links to relevant documentation, articles, or resources -->
